...
forallQ6_ :: OperationClass a => [a] -> [a] -> [a] -> [a] -> [a] -> [a] -> (Effect -> Effect -> Effect -> Effect -> Effect -> Effect -> Fol a) -> Fol a
forallQ6_ l1 l2 l3 l4 l5 l6 f = forallQ_ l1 $ \a -> forallQ_ l2 $ \b -> forallQ_ l3 $ \c -> forallQ_ l4 $ \d -> forallQ_ l5 $ \e -> forallQ_ l6 $ \g -> f a b c d e g
